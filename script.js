...
const PRODUCTS = [
  ...
  { id: 8,  name: 'Rosé Garden',       category: 'Wine',    price: 16.00, badge: '20%', dist: '2.0km', outlet: 'WINE CELLAR CO.',       desc: 'Provençal-style rosé bursting with strawberry, peach blossom and rose petal aromas.', vol: '750ml', vols: ['375ml','750ml','1.5L'], rating: 4.3, stock: 18, isTrending: true,  img: 'https://images.wine.co.za/GetWineImage.ashx?ImageSize=large&IMAGEID=273921' },
